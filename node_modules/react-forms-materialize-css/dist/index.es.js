    ...
    createClass(InputField, [{
        ...
        value: function renderIcon() {
            if (!(typeof this.props.icon == "undefined")) {
                if (this.props.iconRight === true) {
                    return React.createElement(Icon, { icon: this.props.icon, right: this.props.iconRight });
                } else if (this.props.iconLeft === true) {
                    return React.createElement(Icon, { icon: this.props.icon, left: this.props.iconLeft });
                }
                return React.createElement(Icon, { icon: this.props.icon, prefix: true });
            }
            return null;
        }
    }, {
        ...
        value: function renderTextFieldOrArea() {
            ...
            if (this.props.textAreaProps) {
                return React.createElement(TextArea, { elementProps: this.props.textAreaProps,
                    disabled: this.props.disabled,
                    value: this.props.value,
                    onChange: this.props.onChange });
            } else if (this.props.textFieldProps) {
                return React.createElement(TextField, { elementProps: this.props.textFieldProps,
                    disabled: this.props.disabled,
                    value: this.props.value,
                    onChange: this.props.onChange });
            }
        ...
        value: function renderInputLabel() {
            if (typeof this.props.labelText != "undefined") {
                return React.createElement(InputLabel, { "for": this.props.textFieldProps ? this.props.textFieldProps["id"] : this.props.textAreaProps["id"],
        ...
        value: function renderHelperLabel() {
            if (typeof this.props.helperTextText != "undefined") {
                return React.createElement(HelperText, { dataError: this.props.dataError,
                    dataSuccess: this.props.dataSuccess,
...
var Component$$1 = function () {
   ...
   */
  function Component$$1(classDef, el, options) {
...
var Form = function (_Component) {
    ...
    createClass(Form, [{
        ...
        value: function renderHTML(formJson) {
            ...
            for (var row in formJson) {
                ...
                for (var field in row) {
                    ...
                    if (name !== "submit" && ("textFieldProps" in fieldObj || "textAreaProps" in fieldObj)) {
                        ...
                        comp = React.createElement(InputField, _extends({}, fieldObj, {
                            onChange: this["handleChangeFor" + name],
                            disabled: this.state[[name + "Disabled"]] }));
                    } else if (name === "submit") {
                        comp = React.createElement(SubmitButton, _extends({}, fieldObj, {
                ...
                var rowComp = React.createElement.apply(React, ['div', { className: "row" }].concat(rowComps));
            ...
            // Say no to div soup
            var formComps = React.createElement.apply(React, [React.Fragment, null].concat(comps));

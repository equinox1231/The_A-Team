    ...
    createClass(TextField, [{
        ...
        value: function render() {
            return React__default.createElement(
                "input",
                _extends({}, this.props.elementProps, {
...
var Icon = function (_Component) {
    ...
    createClass(Icon, [{
        ...
        value: function render() {
            return React__default.createElement(
                "i",
                { className: "material-icons" + (this.props.prefix ? " prefix" : "") + (this.props.right ? " right" : "") + (this.props.left ? " left" : "") },
                this.props.icon
            );
        }
    }]);
...
var InputLabel = function (_Component) {
    inherits(InputLabel, _Component);

    function InputLabel() {
        classCallCheck(this, InputLabel);
        return possibleConstructorReturn(this, (InputLabel.__proto__ || Object.getPrototypeOf(InputLabel)).apply(this, arguments));
    }

    createClass(InputLabel, [{
        key: "render",
        value: function render() {
            return React__default.createElement(
                "label",
...
var HelperText = function (_Component) {
    inherits(HelperText, _Component);

    function HelperText() {
        classCallCheck(this, HelperText);
        return possibleConstructorReturn(this, (HelperText.__proto__ || Object.getPrototypeOf(HelperText)).apply(this, arguments));
    }

    createClass(HelperText, [{
        key: "render",
        value: function render() {
            return React__default.createElement(
                "span",
...
var InputField = function (_Component) {
    ...
    function InputField(props) {
        ...
        var _this = possibleConstructorReturn(this, (InputField.__proto__ || Object.getPrototypeOf(InputField)).call(this, props));

        _this.renderTextFieldOrArea = _this.renderTextFieldOrArea.bind(_this);
        _this.getClassNames = _this.getClassNames.bind(_this);
        _this.renderIcon = _this.renderIcon.bind(_this);
        _this.renderInputLabel = _this.renderInputLabel.bind(_this);
        _this.renderHelperLabel = _this.renderHelperLabel.bind(_this);
        return _this;
    }
    ...
    createClass(InputField, [{
        ...
        value: function renderIcon() {
            if (!(typeof this.props.icon == "undefined")) {
                if (this.props.iconRight === true) {
                    return React__default.createElement(Icon, { icon: this.props.icon, right: this.props.iconRight });
                } else if (this.props.iconLeft === true) {
                    return React__default.createElement(Icon, { icon: this.props.icon, left: this.props.iconLeft });
                }
                return React__default.createElement(Icon, { icon: this.props.icon, prefix: true });
            }
            return null;
        }
    }, {
        key: "renderTextFieldOrArea",
        value: function renderTextFieldOrArea() {
            ...
            if (this.props.textAreaProps) {
                return React__default.createElement(TextArea, { elementProps: this.props.textAreaProps,
                    disabled: this.props.disabled,
                    value: this.props.value,
                    onChange: this.props.onChange });
            } else if (this.props.textFieldProps) {
                return React__default.createElement(TextField, { elementProps: this.props.textFieldProps,
                    disabled: this.props.disabled,
                    value: this.props.value,
                    onChange: this.props.onChange });
            }
        ...
        value: function renderInputLabel() {
            if (typeof this.props.labelText != "undefined") {
                return React__default.createElement(InputLabel, { "for": this.props.textFieldProps ? this.props.textFieldProps["id"] : this.props.textAreaProps["id"],
                    labelText: this.props.labelText });
            }
            return null;
        }
    }, {
        key: "renderHelperLabel",
        value: function renderHelperLabel() {
            if (typeof this.props.helperTextText != "undefined") {
                return React__default.createElement(HelperText, { dataError: this.props.dataError,
                    dataSuccess: this.props.dataSuccess,
        ...
        value: function render() {
            return React__default.createElement(
                "div",
                { className: "col input-field" + (this.getClassNames !== '' ? ' ' + this.getClassNames() : this.getClassNames()) },
                this.renderIcon(),
...
var SubmitButton = function (_Component) {
    inherits(SubmitButton, _Component);

    function SubmitButton(props) {
        classCallCheck(this, SubmitButton);

        var _this = possibleConstructorReturn(this, (SubmitButton.__proto__ || Object.getPrototypeOf(SubmitButton)).call(this, props));
    ...
    createClass(SubmitButton, [{
        ...
        value: function renderIcon() {
            if (typeof this.props.icon != "undefined") {
                ...
                return React__default.createElement(Icon, { icon: this.props.icon });
            }
            return null;
        }
    }, {
...
var Form = function (_Component) {
    ...
    function Form(props) {
        ...
        _this.fetchFormData(props.formDataFileName).then(_this.loadState);
        return _this;
    }
    ...
    createClass(Form, [{
        ...
        key: "fetchFormData",
        value: function () {
            var _ref = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(formDataFileName) {
                var status, json, formData;
                        ...
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                */
                                ...
                                formData = void 0;
                                _context.next = 5;
                                return fetch("forms/" + formDataFileName).then(status).then(json).then(
        ...
        key: "loadState",
        value: function loadState(formJson) {
            // This function generates the state from the JSON data 
            var names = {};
            for (var row in formJson) {
                row = formJson[row];
                for (var field in row) {
                    ...
                    if (field !== "submit" && ("textFieldProps" in fieldObj || "textAreaProps" in fieldObj)) {
                        ...
                        this.setState(defineProperty({}, field + "Value", fieldObj["value"] ? fieldObj["value"] : ""));
                        ...
                        if (typeof fieldObj["disabled"] === "undefined" || fieldObj["disabled"] === false || fieldObj["disabled"] === "false") {
                            this.setState(defineProperty({}, field + "Disabled", false));
                        } else if (fieldObj["disbaled"] === true || fieldObj["disbaled"] === "true") {
                            this.setState(defineProperty({}, field + "Disabled", true));
                        } else {
        ...
        key: "renderHTML",
        value: function renderHTML(formJson) {
            var _this2 = this;
            ...
            for (var row in formJson) {
                ...
                for (var field in row) {
                    ...
                    if (name !== "submit" && ("textFieldProps" in fieldObj || "textAreaProps" in fieldObj)) {
                        ...
                        var onchangefunc = void 0;
                        // custom onChange functions mapped to field component names 
                        if (_typeof(this.props.onChangeFuncs) === "object" && typeof this.props.onChangeFuncs[name] === "function") {
                            (function () {
                                var exec = _this2.props.onChangeFuncs[name];
                                if (typeof _this2.props.onChangeFuncBase === "function") {
                                    var onChangeFuncBase = _this2.props.onChangeFuncBase;
                                    onchangefunc = function onchangefunc(event) {
                                        onChangeFuncBase(event);
                                        exec(event);
                                    };
                                } else {
                                    onchangefunc = function onchangefunc(event) {
                                        this.setState(defineProperty({}, event.target.name + "Value", event.target.value));
                                        exec(event);
                                    };
                                }
                            })();
                        ...
                        comp = React__default.createElement(InputField, _extends({}, fieldObj, {
                            onChange: this["handleChangeFor" + name],
                            disabled: this.state[[name + "Disabled"]] }));
                    } else if (name === "submit") {
                        comp = React__default.createElement(SubmitButton, _extends({}, fieldObj, {
                ...
                var rowComp = React__default.createElement.apply(React__default, ['div', { className: "row" }].concat(rowComps));
            ...
            // Say no to div soup
            var formComps = React__default.createElement.apply(React__default, [React__default.Fragment, null].concat(comps));
        ...
        value: function renderSwitch() {
            ...
            if (this.state.dataLoaded) {
                ...
                return React__default.createElement(
                    "div",
                    { className: "progress" },
                    React__default.createElement("div", { className: "indeterminate" })
                );
            }
        }
    }, {
